...
import com.firstadie.csftcarroll.b00641329.firstaide.utils.LayoutUtils;
...
public class TimelineView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        mMarkerSize = typedArray.getDimensionPixelSize(R.styleable.timeline_style_markerSize, LayoutUtils.dpToPx(20, mContext));
        mLineSize = typedArray.getDimensionPixelSize(R.styleable.timeline_style_lineSize, LayoutUtils.dpToPx(2, mContext));
